...
namespace BackendLab01.Migrations
{
    ...
    [Migration("20240424120242_init2")]
    partial class init2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infrastructure.EF.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "aeefa571-28a8-4606-adb0-98896242787b",
                            Email = "321@gmail.com",
            ...
            modelBuilder.Entity("Infrastructure.EF.UserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Infrastructure.EF.UserRole", null)
                        .WithMany()
